...
The REST API documentation can be found on [docs.deepcoder.com](https://docs.deepcoder.com). The full API of this library can be found in [api.md](api.md).
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/deepcoder-typescript.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/deepcoder-typescript/issues) with questions, bugs, or suggestions.
