import fs from 'fs';
import type { ResponseLike } from 'deepcode-ai/deepcoder/internal/to-file';
import { toFile } from 'deepcode-ai/deepcoder/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('deepcode-ai/deepcoder/core/uploads');
    await expect(
